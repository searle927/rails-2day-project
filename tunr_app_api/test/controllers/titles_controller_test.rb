...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { artist: @title.artist, duration: @title.duration, favorite: @title.favorite } }, as: :json
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { artist: @title.artist, duration: @title.duration, favorite: @title.favorite } }, as: :json
    assert_response 200
  end
